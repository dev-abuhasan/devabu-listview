...
var StickyObject = /** @class */ (function (_super) {
    ...
    StickyObject.prototype.onScroll = function (offsetY) {
        ...
        if (this._previousStickyIndex !== undefined) {
            if (this._previousStickyIndex * this.stickyTypeMultiplier >=
            ...
            if (this._previousHeight &&
                this._currentYd &&
                scrollY_1 &&
                scrollY_1 < this._currentYd) {
                if (scrollY_1 > this._currentYd - this._previousHeight) {
                    this.currentIndex -= this.stickyTypeMultiplier;
                    var translate = (scrollY_1 - this._currentYd + this._previousHeight) *
        ...
        if (this._nextStickyIndex !== undefined) {
            if (this._nextStickyIndex * this.stickyTypeMultiplier <=
                this.currentStickyIndex * this.stickyTypeMultiplier) {
                throw new CustomError_1.default(RecyclerListViewExceptions_1.default.stickyIndicesArraySortError);
            }
            ...
            if (this._currentHeight &&
                this._nextYd &&
                scrollY_2 &&
                scrollY_2 + this._currentHeight > this._nextYd) {
                if (scrollY_2 <= this._nextYd) {
                    var translate = (scrollY_2 - this._nextYd + this._currentHeight) *
                        (-1 * this.stickyTypeMultiplier);
                    this._stickyViewOffset.setValue(translate);
                }
    ...
    StickyObject.prototype.getWindowCorrection = function (props) {
        return ((props.getWindowCorrection && props.getWindowCorrection()) ||
    ...
    StickyObject.prototype._computeLayouts = function (newStickyIndices) {
        var stickyIndices = newStickyIndices
            ? newStickyIndices
