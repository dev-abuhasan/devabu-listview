...
var ViewRenderer = /** @class */ (function (_super) {
    ...
    ViewRenderer.prototype.renderCompat = function () {
        var style = this.props.forceNonDeterministicRendering
            ? __assign(__assign(__assign({ transform: this._getTransform(), width: 768, WebkitTransform: this._getTransform() }, this.props.styleOverrides), this.animatorStyleOverrides), this.props.baseViewStyle) : __assign(__assign(__assign(__assign({ height: this.props.height, overflow: "hidden", width: this.props.width, transform: this._getTransform(), WebkitTransform: this._getTransform() }, styles.baseViewStyle), this.props.styleOverrides), this.animatorStyleOverrides), this.props.baseViewStyle);
        var props = {
            style: style,
            ref: this._setRef,
        };
    ...
    ViewRenderer.prototype._renderItemContainer = function (props, parentProps, children) {
        return ((this.props.renderItemContainer &&
            this.props.renderItemContainer(props, parentProps, children)) || (React.createElement("div", __assign({ "data-index": this.props.index }, props, { className: "viewRendererContainer" }), children)));
    };
    ...
    ViewRenderer.prototype._checkSizeChange = function (fromObserver) {
        ...
        if (this.props.forceNonDeterministicRendering &&
            ...
            if (mainDiv) {
                ...
                if (this.props.width !== this._dim.width ||
